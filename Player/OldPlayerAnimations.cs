...
public class OldPlayerAnimations : MonoBehaviour
{
    ...
    private AnimationStates state { set { updateAnimationState(value); _state = value; } get { return _state; } }
    private AnimationStates _state;
    private void updateAnimationState(AnimationStates newvalue)
    {
        foreach (AnimationStates anim in StateMapping.GetKeys())
        {
            myAnim.SetBool(StateMapping[anim], anim == newvalue); // with new system this would be replaced with crossfade
        }
    }
    ...
    {
        [AnimationStates.IdleSide] = "IdleSide",
        [AnimationStates.WalkingSide] = "WalkingSide",
        [AnimationStates.WalkingNorth] = "WalkingNorth",
        [AnimationStates.WalkingSouth] = "WalkingSouth",
        [AnimationStates.BasicAttackSide] = "Side Attack",
        [AnimationStates.BasicAttackSouth] = "South Attack",
        [AnimationStates.BasicAttackNorth] = "North Attack",
